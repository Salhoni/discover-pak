...
# Import folium and handle import error
try:
    import folium
    from streamlit_folium import folium_static
except ModuleNotFoundError:
    st.error("The 'folium' library is not installed. Please ensure it is in your requirements.txt file.")
...
if 'folium' in globals():
    ...
    st.error("Map feature not available as 'folium' library is not installed.")
